import type { Drill, Goal, SessionFocus } from './types';
...
export const exerciseLibrary: ExerciseLibrary = {
  prepare: {
    general: [
      ...
      { name: 'Brisk treadmill walk', dosage: '60-90 sec', coachingCue: 'Smooth rhythm and relaxed shoulders.' },
      { name: 'Light sled march or drag', dosage: '2 x 15-20 m', coachingCue: 'Tall posture and crisp steps.' }
    ]
  },
  position: {
    general: [
  ...
  access: {
    ...
    hip: [
      { name: 'Adductor rockback', dosage: '6-8 reps/side', coachingCue: 'Keep spine long and move from the hip.' },
      { name: '90/90 hip transitions', dosage: '4-6 reps/side', coachingCue: 'Own the turn and do not rush.' }
    ],
    tSpine: [
      { name: 'Quadruped T-spine rotation', dosage: '5-6 reps/side', coachingCue: 'Rotate through upper back, not low back.' }
    ],
    shoulder: [
      { name: 'Dynamic pec stretch', dosage: '6-8 reps/side', coachingCue: 'Smooth range with no yanking.' },
  ...
  integrate: {
    squat: [
      ...
      { name: 'Bodyweight squat with pause', dosage: '5-6 reps', coachingCue: 'Own the bottom position and whole-foot pressure.' },
      { name: 'Goblet squat', dosage: '3-5 reps', coachingCue: 'Brace first and descend under control.' }
    ],
    bench: [
    ...
    full_body: [
      { name: 'Bear crawl', dosage: '2 x 10 m', coachingCue: 'Quiet trunk with opposite hand and foot.' },
      { name: 'Farmer carry', dosage: '2 x 15-20 m', coachingCue: 'Tall posture and steady ribcage.' }
    ]
  },
  express: {
    power: [
      { name: 'Vertical jump', dosage: '2-3 reps', coachingCue: 'High intent with full reset between reps.' },
    ...
    fatigueFriendly: [
      { name: 'Quick feet or low pogo', dosage: '10-15 sec', coachingCue: 'Stay springy, not sloppy.' }
    ]
  }
};

export type ExpressBucket = keyof ExerciseLibrary['express'];

export function inferExpressBucket(goal: Goal, focus: SessionFocus): ExpressBucket {
  if (goal === 'power' || goal === 'sport_specific') {
    return 'power';
  }
